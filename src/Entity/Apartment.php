...
class Apartment
{
    ...
    #[ORM\OneToMany(mappedBy: 'apartmentReservation', targetEntity: Reservation::class, orphanRemoval: true)]
    ...
    public function addReservation(Reservation $reservation): self
    {
        if (!$this->reservations->contains($reservation)) {
            ...
            $reservation->setApartmentReservation($this);
        }
    ...
    public function removeReservation(Reservation $reservation): self
    {
        if ($this->reservations->removeElement($reservation)) {
            ...
            if ($reservation->getApartmentReservation() === $this) {
                $reservation->setApartmentReservation(null);
            }
        }
